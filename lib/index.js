...
exports.fixedEncodeURIComponent = exports.fromRestli = exports.toRestli = exports.toParams = void 0;
/**
...
var toRestli = function (obj) {
    if (Array.isArray(obj)) {
        ...
        var strObj = Object.keys(obj).map(function (key) { return fixedEncodeURIComponent(key) + ":" + toRestli(obj[key]); });
        return "(" + strObj + ")";
    }
    else {
